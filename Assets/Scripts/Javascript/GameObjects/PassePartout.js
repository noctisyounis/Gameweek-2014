...
function PassePartout (transform, boxCollider, name, message, mymaterial, parent)
{
	this.name = name;
	this.enabled = true;
	this.physics = true;
	...
	this.OnClicked = function ()
	{
		...
		if(Input.MouseClick && Dialogue.finished)
		{
			...
			Dialogue.Continue();
			if(!Progression.RoutePassive) Progression.RouteBGotPassePartout = true;
			else Progression.RouteAGotPassePartout = true;

			this.parent.GameObjects.splice(this.parent.GameObjects.indexOf(this), 1);
		}
