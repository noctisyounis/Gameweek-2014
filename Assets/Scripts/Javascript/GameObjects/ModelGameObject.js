...
function GameObject ()
{
		...
		Draw: function ()
		{
			if(this.Renderer.visible)
			{
				ctx.DrawImage(this.Renderer.material, 
					this.Renderer.Material.CurrentState.x, 
					this.Renderer.Material.CurrentState.y, 
	...
	this.Awake = function()
	{
		...
		{
			this.Renderer.Material.sizeFrame.x = src.height / numberOfFrameY;
			this.Renderer.Material.sizeFrame.y = src.width  / numberOfFrameX;
		}
